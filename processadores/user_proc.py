...
from manager.forms.user_form import UserForm, UserEditForm, UserResetPassword
...
def create(request, **kwargs):
    ...
    if form.is_valid():
        ...
        user.save()
        return redirect('manager:list_user')
...
def resetar_senha(request, user):
    ...
    form_data = render_to_string('modal/ajax/forms.html', {'form': form})
    data = {
        'result': form_data,
        'success': success,
    }
